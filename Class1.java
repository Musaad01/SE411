...

{
...

    {
        ...
        String[] shopItems = { "Silver Sword", "Steel Sword", "Iron Helmet", "Iron Chestplate", "Iron Boots",
                "Iron Gauntlets", "Steel Helmet", "Steel Chestplate", "Steel Boots", "Steel Gauntlets", "Illbane" };
...

        {
...

            {
...

                {
                    ...
                    if (numHealthPotions > 0) {
                        ...
                        numHealthPotions--;
                        System.out
                                .println("\t> You drink a health potion and recover " + healthPotionEffect + " health!"
...

                {
                    ...
                    System.out.println("You drank a strength potion and your attack has multiplied by: "
...

            {
...

                {
...

                    {
                        ...
                        if (numHealthPotions > 0) {
                            ...
                            numHealthPotions--;
                            System.out.println(
                                    "\t> You drink a health potion and recover " + healthPotionEffect + " health!"
                                            + "\n\t> You now have " + playerHealth + " HP."
                                            + "\n\t> You have " + numHealthPotions + " health potions left.\n)");
...

                {
                    ...
                    System.out.println("\t>!!!# You recieve " + redDrakeSpecialAttackValue
...

                {
                    ...
                    System.out.println(
                            " # You have " + numHealthPotions + " health potion(s), and " + numStrengthPotions + "! #");
